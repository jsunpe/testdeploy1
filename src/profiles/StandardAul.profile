...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <applicationVisibilities>
        <application>Quick_Create_Toolbar</application>
        <default>false</default>
        <visible>true</visible>
    </applicationVisibilities>
    <classAccesses>
        <apexClass>NewCaseVFExCon</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>QuickCreateToolbarCon</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <fieldPermissions>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>Account.Test_Commit_Checkbox__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <layoutAssignments>
        <layout>Opportunity-Opportunity Layout</layout>
        <recordType>Opportunity.Test_Opportunity</recordType>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <pageAccesses>
        <apexPage>NewCaseVF</apexPage>
        <enabled>false</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>QuickCreateToolbarAccountInlineVF</apexPage>
        <enabled>false</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>QuickCreateToolbarAssetInlineVF</apexPage>
        <enabled>false</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>QuickCreateToolbarCaseInlineVF</apexPage>
        <enabled>false</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>QuickCreateToolbarContactInlineVF</apexPage>
        <enabled>false</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>QuickCreateToolbarContractInlineVF</apexPage>
        <enabled>false</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>QuickCreateToolbarGuide</apexPage>
        <enabled>false</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>QuickCreateToolbarOpportunityInlineVF</apexPage>
        <enabled>false</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>QuickCreateToolbarSCCVF</apexPage>
        <enabled>false</enabled>
    </pageAccesses>
